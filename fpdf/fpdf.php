...
// Compatibility method for PHP 7.4+
...
function _dochecks()
{
	...
	// Ensure runtime magic quotes are disabled (deprecated in PHP 7.4+)
...
function _beginpage($orientation, $size)
{
	...
	if(is_array($this->DefPageSize) && is_array($size) && ($orientation!=$this->DefOrientation || $size[0]!=$this->DefPageSize[0] || $size[1]!=$this->DefPageSize[1]))
